...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------- |
| Gate A approved?                  | Independent decision is `APPROVED`, names the exact remediation code/evidence commits, and reports zero BLOCKER/MAJOR.                                 | Review path, review commit, reviewed SHAs, decision |
...
| Foundation status valid?          | V02.1-V05.3 are `VERIFIED` through policy-valid independent evidence; governance passes.                                                               | status/decision paths and validator output          |
...
| Batch-candidate policy activated? | A separate owner-approved active record exactly scopes V06.1-V10.4 and preserves Gate B/P0/production/V11 controls. This draft alone is insufficient.  | active policy path and approval record              |
