...
Focused V28.1/V30.1 tests passed 11/11 on this integration branch. Targeted
...
The reused V28.1 Core candidate is still isolated preparation and must not
be merged or activated before its Constitution R002/ADR-14 reconciliation,
