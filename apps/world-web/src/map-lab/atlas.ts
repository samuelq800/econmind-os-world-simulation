...
function visualTerritoryPolygon(xKm: number, yKm: number, index: number) {
  ...
  return shape(
    [xKm - horizontalRadius, yKm - verticalRadius / 2],
    [xKm - horizontalRadius / 2, yKm - verticalRadius],
    [xKm + horizontalRadius * 0.72, yKm - verticalRadius * 0.76],
    [xKm + horizontalRadius, yKm + verticalRadius / 4],
    [xKm + horizontalRadius / 2, yKm + verticalRadius],
    [xKm - horizontalRadius * 0.66, yKm + verticalRadius * 0.72],
  );
}
