  ...
  it('preserves the approved continuation history and final package closure', () => {
    ...
    expect(progress.current_gate).toMatchObject({
      ...
      next_step_blockers: [
        ...
        'full real PostgreSQL multi-process and process-kill recovery evidence beyond the V10.4 two-pool contention, transaction-failure reconnect, and acknowledgement-loss scenarios',
