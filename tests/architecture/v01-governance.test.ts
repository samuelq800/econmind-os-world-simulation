...
describe('V06 owner-authorized package continuation', () => {
  it('preserves the approved continuation history and final package closure', () => {
    ...
    expect(progress.v10_2_adr_entry).toEqual({
      ...
      durable_persistence_candidate: 'c77ac9c52a8d49de76269075c0adf1a2fe10018e',
      durable_persistence_status: 'IMPLEMENTED_UNVERIFIED',
      durable_persistence_checks:
        'PASS — Worker typecheck; 3 files / 6 focused V10.2 core/schema/cutoff tests; target lint; architecture 9 files / 84 tests; local migration validation and clean/existing-schema rehearsal',
