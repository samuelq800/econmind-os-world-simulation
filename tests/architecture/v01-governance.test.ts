  ...
  it('preserves the approved continuation history and final package closure', () => {
    ...
    expect(progress.current_gate).toMatchObject({
      ...
      next_step_blockers: [
        ...
        'full real PostgreSQL multi-process and process-kill recovery across the complete V10 lifecycle beyond the narrow V10.4 two-pool contention, transaction-failure reconnect, acknowledgement-loss, and one delivery process-kill scenarios',
